...
with core.Library('protorpc') as (protorpc, library):
  ...
  try:
      ...
      #
      # The canteen service layer requires ProtoRPC to function.
      #

      print 'ProtoRPC could not be found - service layer not available.'
